...
public class PocketPageContainer implements Container {
    ...
    public PocketPageContainer(ItemStack bag, HolderLookup.Provider registries, String key, int size, boolean clientSide) {
        this.bag = bag;
    ...
    public void reload() {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            if (root != null) {
                ...
                if (!slotTag.isEmpty()) {
                    stack = ItemStack.parseOptional(this.registries, slotTag);
                }
            }
    ...
    public void save() {
        ...
        for (int i = 0; i < this.size; i++) {
            ...
            if (stack.isEmpty()) {
                ...
                net.minecraft.nbt.Tag tag = stack.saveOptional(this.registries);
                if (tag instanceof CompoundTag compound) {
                    root.put(keyOf(i), compound);
                }
            }
        }
