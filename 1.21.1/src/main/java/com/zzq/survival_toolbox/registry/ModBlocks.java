...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(Registries.BLOCK, SurvivalToolbox.MODID);
    ...
    /** 拆解台方块（用于逆向合成与酿造拆解） */
    public static final DeferredHolder<Block, DisassembleBlock> DISASSEMBLE_TABLE = registerBlock(
            "disassemble_table",
    ...
    public static final DeferredHolder<Block, MicroFarmBlock> MICRO_FARM = registerBlock("micro_farm",
    ...
    /** 万物转化炉方块（消耗燃料复制物品） */
    public static final DeferredHolder<Block, TransmutationFurnaceBlock> TRANSMUTATION_FURNACE = registerBlock("transmutation_furnace",
    ...
    public static final DeferredHolder<Block, GuardianLanternBlock> GUARDIAN_LANTERN = registerBlock("guardian_lantern",
    ...
    public static final DeferredHolder<Block, SmartFarmBlock> SMART_FARM = registerBlock("smart_farm",
    ...
    /** 无限之源方块（无限流体供应源） */
    public static final DeferredHolder<Block, InfiniteSourceBlock> INFINITE_SOURCE = registerBlock("infinite_source",
    ...
    /** 万向漏斗方块（六向可配置物品传输） */
    public static final DeferredHolder<Block, OmniHopperBlock> OMNI_HOPPER = registerBlock("omni_hopper",
    ...
    public static final DeferredHolder<Block, EnchantmentTransferBlock> ENCHANTMENT_TRANSFER = registerBlock(
    ...
    public static final DeferredHolder<Block, FeastBlock> FEAST = registerBlock(
            "feast",
    ...
    public static final DeferredHolder<Block, TemperingBoxBlock> TEMPERING_BOX = registerBlock(
            "tempering_box",
