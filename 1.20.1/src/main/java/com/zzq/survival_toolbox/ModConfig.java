 ...
 * </p>
 */
@Mod.EventBusSubscriber(modid = "zzq_survival_toolbox", bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModConfig {
    ...
    public static void register() {
        FMLJavaModLoadingContext.get().getModEventBus().addListener(
                (ModConfigEvent.Loading event) -> ModConfig.bake()
        );
    }
    ...
    public static class ClientConfig {
        ...
        public final ForgeConfigSpec.BooleanValue enableAttackMessage;
        public final ForgeConfigSpec.DoubleValue killAbsorbMultiplier;
        public final ForgeConfigSpec.DoubleValue maxBonus;
        public final ForgeConfigSpec.DoubleValue healMultiplier;
        public final ForgeConfigSpec.DoubleValue repairMultiplier;

        // 自适应核心
        public final ForgeConfigSpec.DoubleValue adaptMaxLayers;
        public final ForgeConfigSpec.DoubleValue adaptLayerGainMultiplier;
        public final ForgeConfigSpec.DoubleValue adaptLayerDamageReduction;
        public final ForgeConfigSpec.DoubleValue adaptShieldCap;
        public final ForgeConfigSpec.DoubleValue adaptShieldPerLayer;
        public final ForgeConfigSpec.DoubleValue adaptShieldRegenBase;
        public final ForgeConfigSpec.DoubleValue adaptShieldRegenBonus;

        // 能力阈值
        public final ForgeConfigSpec.IntValue adaptFlightThreshold;
        public final ForgeConfigSpec.IntValue adaptReviveThreshold;
        public final ForgeConfigSpec.IntValue adaptReviveCost;
        ...
        public final ForgeConfigSpec.DoubleValue adaptArmorRepairPerLayer;

        // 消息开关
        public final ForgeConfigSpec.BooleanValue enableAdaptationLayerMessage;
        public final ForgeConfigSpec.BooleanValue enableAdaptationRestoreMessage;

        // 护盾条 UI
        public final ForgeConfigSpec.BooleanValue showShieldBarText;
        public final ForgeConfigSpec.IntValue shieldBarX;
        public final ForgeConfigSpec.IntValue shieldBarY;
        public final ForgeConfigSpec.IntValue shieldBarWidth;
        public final ForgeConfigSpec.IntValue shieldBarHeight;
    ...
    public static class CommonConfig {
        public final ForgeConfigSpec.DoubleValue anvilOrbHealthThreshold;
        public final ForgeConfigSpec.ConfigValue<List<? extends String>> anvilOrbBlacklist;
