 ...
 * <p>
 * 方向由袋子里的托盘方向决定（界面右侧"送出/纳入"切换，存在袋子 NBT 里）：
...
public class PocketTrayInteractHandler {
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        // 1.20.1 的 getFace() 标了 @Nullable（其它模组可能不带方向发这个事件），
        // 为 null 时按"无方向查询"处理，能力查询照样能用。
        ...
        //    ⚠️ 只有"纳入"才吸（装液体跟托盘状态走）：送出方向下瞄准水面不该偷水。
        ...
        if (out) {
            ...
            // 只有一种液体但它是"没有方块形态"的（机械动力那类）：给句话，别让玩家对着空气右键
